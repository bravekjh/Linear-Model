...
\begin{align*}
%
\bm{\beta} | \sigma^2 & \sim N(0, \sigma^2 \bm{D}_\gamma) & \bm{D}_\gamma &  = diag(\gamma_1, \ldots, \gamma_p)\\
%
...
%
\gamma_j & \sim Exp(\lambda^2/2) for each j = 1, \ldots, p\\
%
\lambda^2 & \sim Gamma(\alpha_\lambda, \beta_\lambda)
%
\end{align*}
%
where $p is the number of parameters in $\bm{\beta}$.
%
\section{Posterior}
%
\begin{align*}
